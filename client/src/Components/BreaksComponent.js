...
import { faClockFour, faFaceTired } from "@fortawesome/free-solid-svg-icons";
...
const Bubble = styled.section`
  ...
  margin-bottom: 5em;
  display: grid;
  grid-template-areas: "bars radiobuttons";
...
const RadioButtonsContainer = styled.form`
  ...
  display: grid;
  height: auto;
  grid-template-areas: "length meditation";
`;
    ...
    <Bubble>
      ...
      <RadioButtonsContainer>
        <LengthButton>
          ...
          <input type="radio" id="10" name="break-length" value="10" />
          <br />

          <label>20 minutes</label>
          <input type="radio" id="20" name="break-length" value="20" />
          ...
          <button id="radio-button-submit" onClick={addABreak}>
            <FontAwesomeIcon
              icon={faClockFour}
              id="timer-button"
              style={{ width: "30px", height: "30px", margin: -8 }}
            />
          </button>
        </LengthButton>
        <br /> <br />
